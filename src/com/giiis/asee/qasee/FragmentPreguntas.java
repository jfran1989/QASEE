...
public class FragmentPreguntas extends Fragment{
    ...
    public static FragmentPreguntas newInstance(String text) {
    	FragmentPreguntas frag = new FragmentPreguntas();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_preguntas, container,
                false);
