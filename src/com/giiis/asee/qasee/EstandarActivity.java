...
public class EstandarActivity extends ActionBarActivity {
	...
	public void iniciarComponentes() throws InterruptedException{
       ...
       /* manager.insertarPregunta("En C++ ¿A qué le llamamos función?", 1,"EDI","Sección del programa que realiza una tarea", "Resolución de un problema", "Comando de preprocesador", "Secuencia de escape",  1);
        
        manager.insertarPregunta("En la estructura de programas de C++ ¿Qué tipo de programación usamos?", 2,"EDI" , "Binaria", "Modular", "Anticuada", "Todas las anteriores", 2);
        manager.insertarPregunta("¿De qué se encarga la función principal?", 3, "EDI", "Ejecutar las otras funciones", "Es la función controladora", "No puede haber más de una función", "Todas las anteriores", 4);
        manager.insertarPregunta("¿Cómo creamos una función?", 4, "EDI", " iterate(nombre);", "crea_función_con_nombre", "tipodedato nombre parametros;", "56_dofuction;", 3);
        manager.insertarPregunta("¿Qué es un comando de preprocesador?", 5, "EDI", "El comando que compila el programa", "Un comando en binario", "Un tipo de dato primitivo", "Se ejecuta y realiza una acción precompilada", 4);
        manager.insertarPregunta("¿Para que usamos el comando #include?", 6, "EDI", "Para salir", "Para incluir las librerías", "Para mostrar una vista previa", "Para simular un enter", 2);
        manager.insertarPregunta("¿Para qué incluimos la librería <iostream>?", 7, "EDI", " Para usar un flujo de entrada y salida", "Para ver en negritas el cout", "Para incluir las librerías", "Para salir", 1);
        manager.insertarPregunta(" Un ejemplo de como usar el cout es:", 8, "EDI", "cout<<Hola mundo\n", "cout>>numero;", " cout = 10;", "cout(pause);", 1);
        manager.insertarPregunta("¿Qué es una cadena?", 9, "EDI", "Un conjunto de signos <<", "Cuando ponemos ;", "Una combinación de letras, números o caracteres especiales", "Un numero binario muy largo", 3);
